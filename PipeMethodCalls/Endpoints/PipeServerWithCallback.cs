...
namespace PipeMethodCalls
{
		...
		where THandling : class
	{
		...
		public PipeServerWithCallback(IPipeSerializer serializer, string pipeName, Func<THandling> handlerFactoryFunc, PipeOptions? options = null, int maxNumberOfServerInstances = 1)
		{
		...
		public PipeServerWithCallback(IPipeSerializer serializer, NamedPipeServerStream rawPipe, Func<THandling> handlerFactoryFunc)
		{
